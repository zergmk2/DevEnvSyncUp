...
silent only
cd /Development/Qt4/qt-everywhere-opensource-src-4.7.3/src/dbus
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 /Development/Qt4/qt-everywhere-opensource-src-4.7.3/projects.pro
badd +88 /Development/Qt4/qt-everywhere-opensource-src-4.7.3/src/dbus/dbus.pro
badd +14 /Development/Qt4/qt-everywhere-opensource-src-4.7.3/src/dbus/qdbusconnection.h
badd +1 /Development/Qt4/qt-everywhere-opensource-src-4.7.3/src/qbase.pri
badd +75 /Development/Qt4/qt-everywhere-opensource-src-4.7.3/src/dbus/qdbusutil.cpp
badd +1 /Development/Qt4/qt-everywhere-opensource-src-4.7.3/src/dbus/qdbusxmlgenerator.cpp
args /Development/Qt4/qt-everywhere-opensource-src-4.7.3/projects.pro
edit /Development/Qt4/qt-everywhere-opensource-src-4.7.3/src/dbus/qdbusxmlgenerator.cpp
...
silent! normal! zE
let s:l = 78 - ((21 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
normal! 0
lcd /Development/Qt4/qt-everywhere-opensource-src-4.7.3/src/dbus
tabnext 1
if exists('s:wipebuf')
