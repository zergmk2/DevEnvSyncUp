...
silent only
cd /Development/workspace/yaffs
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +718 /Development/workspace/yaffs/yaffs_fs.c
badd +289 /Development/workspace/yaffs/yaffs_guts.h
badd +175 /usr/include/linux/fs.h
badd +334 /Development/workspace/yaffs/yaffs_guts.c
args yaffs_fs.c
edit /Development/workspace/yaffs/[File\ List]
...
exe '2resize ' . ((&lines * 10 + 18) / 36)
exe 'vert 2resize ' . ((&columns * 25 + 74) / 149)
exe '3resize ' . ((&lines * 21 + 18) / 36)
exe 'vert 3resize ' . ((&columns * 25 + 74) / 149)
exe '4resize ' . ((&lines * 32 + 18) / 36)
exe 'vert 4resize ' . ((&columns * 123 + 74) / 149)
argglobal
enew
file /Development/workspace/yaffs/-MiniBufExplorer-
let s:cpo_save=&cpo
set cpo&vim
...
lcd /Development/workspace/yaffs
wincmd w
argglobal
...
argglobal
enew
file /Development/workspace/yaffs/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
edit /Development/workspace/yaffs/yaffs_fs.c
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 896 - ((16 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
896
